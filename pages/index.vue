<template>
  <div class="box-border mx-auto mt-20 sm:container bg-[#FAFBFF]">
    ...
    <MoleculesPlatforms
      :platforms="platforms"
      class="hidden mt-10 lg:mt-20 justify-evenly sm:flex"
    />
    <!-- Who are we -->
    <OrganismsWhoAreWe
      class="mt-24 md:mt-16 lg:mt-20 xl:mt-28 xxl:mt-72 2xl:mt-[33rem] lg:grid lg:grid-cols-2"
    />
    <!-- Our Services -->
    <OrganismsServices />
    ...
    >
      ...
      <!-- How it works -->
      <OrganismsHows class="mt-36" />
    </div>
    <!-- Artists -->
    <OrganismsArtists class="mt-10 lg:mt-32" />
    <!-- Pricing -->
    <OrganismsPricing class="mt-36" />
    <!-- Our Stores -->
    <OrganismsStores class="mt-24" />
    <!-- Download -->
    <OrganismsDownload class="mt-24" />
  </div>
</template>
